<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="" prop="devModel">
        <el-input
    ...
    <el-table v-loading="loading" :data="deviceDetailsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="" align="center" prop="devModel" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['ledger:deviceDetails:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['ledger:deviceDetails:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="deviceDetailsRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="" prop="devModel">
          <el-input v-model="form.devModel" placeholder="请输入" />
        </el-form-item>
      </el-form>
      <template #footer>
...
import { listDeviceDetails, getDeviceDetails, delDeviceDetails, addDeviceDetails, updateDeviceDetails } from "@/api/ledger/deviceDetails";
